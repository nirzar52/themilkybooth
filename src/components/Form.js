        ...
        <main>
            ...
            <section className="callout large contest-info">
                <section className="grid-container">
                    <h1 className="text-center small-text-left">
                        The prizes and chances of winning
                    </h1>
                    <section className="row column text-center small-text-justify">
                        <p>
                            Every customer of our product got a chance of
                            winning a free dairy package!
                        </p>
                        <p>
                            <strong>Yogurt tips:</strong> winners will be
                            determined by random draw but may have their entries
                            removed for any reason by the judges.
                        </p>
                        <p>
                            Users under the age of 16 are not eligible for the
                            activity without a guardian's permission.
                        </p>
                    </section>
                </section>
            </section>
                ...
                <section className="grid-x grid-padding-x">
                    <section className="cell large-8 skill-test">
                        ...
                        <form className="grid-y" action="#">
                            <label for="skillTest" id="skillTest">
                                import_question_here
                            </label>
                            <section className="grid-x">
                            ...
                            <p className="error-msg" id="skillTestError">
                                error_here
                            </p>
                        </form>
                    </section>
                    <section className="cell large-12">
                        <form className="grid-x" action="#">
                            ...
                            <section
                                className="tabbedSection cell large-8"
                                id="guardianDetailsSection"
                            >
                                <fieldset>
                                    <legend>Guardian's Information</legend>
                                    <p
                                        className="error-msg"
                                        id="guardianRequiredError"
                                    >
                                        error_here
                                    </p>
                                    <section className="grid-x grid-padding-x">
                                        ...
                                        <section className="cell large-6">
                                            ...
                                            <p
                                                className="error-msg"
                                                id="guardianLastNameError"
                                            >
                                                error_here
                                            </p>
                                        </section>
                                        <section className="cell large-8">
                                            <label for="guardianEmailId">
                                                Email
                                                <input
                                                    type="text"
                                                    className="input-box"
                                            ...
                                            <p
                                                className="error-msg"
                                                id="guardianEmailIdError"
                                            >
                                                error_here
                                            </p>
                                        </section>
                                        <section className="cell large-8">
                                            <label for="guardianPhoneNum">
                                                Phone number
                                                <input
                                                    type="text"
                                                    className="input-box"
                            ...
                            <section className="cell large-8">
                                <fieldset>
                                    ...
                                    <label for="termsAndConditions">
                                        {" "}
                                        Sign me up to receive emails! (optional)
                                    </label>
                                    <p
                                        className="error-msg"
