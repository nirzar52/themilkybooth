                    ...
                    <section className="cell large-12">
                        <ul className="accordion" data-accordion data-allow-all-closed="true">
                            <li className="accordion-item is-active" data-accordion-item>
                                <a href="#" className="accordion-title">1. How does the Photo Booth service work?</a>
                                <div className="accordion-content" data-tab-content >
                                    <p>Photo Booth offers a digital photography service via the Photo Booth. You can have your picture taken in the Photo Booth (the “Photo”). You’ll have to provide us with your age, and email address or your mobile phone number, so we can send your photo to you. For that you have to click your photo, then we’ll send it to you by email. You understand and agree that we may also display your photo on the screen outside the Photo Booth. In addition, you agree that we and a partner company may send you advertising and marketing materials with recommendations and information that might be of interest to you. Users under the age of 16 are not eligible for the activity without a guardians permission.</p>
                                </div>
                            </li>
                            <li className="accordion-item" data-accordion-item>
                                <a href="#" className="accordion-title">2. Content and Rights of Publicity</a>
                                <div className="accordion-content" data-tab-content>
                                    <p>Once the user uploads photo, the company has ownership of those photos. You give us permission to take your picture and share it on the Photo Booth, and you agree that this action does not violate your rights of publicity or privacy. Nothing in these terms will restrict any rights that you have to use and exploit your own image subject to these Terms. You agree not to use the Photo Booth in any manner that is indecent, pornographic, or in violation of any laws.</p>
                                </div>
                            </li>
                            <li className="accordion-item" data-accordion-item>
                                <a href="#" className="accordion-title">3. Information collection from all users.</a>
                                <div className="accordion-content" data-tab-content>
                            ...
                            <li className="accordion-item" data-accordion-item>
                                <a href="#" className="accordion-title">4. Choice and Opt-out.</a>
                                <div className="accordion-content" data-tab-content>
                                    <p>When you register your emails with us, we will send you weekly newsletters, contact you about products and services we think may be of interest to you. If you agree to us providing you with this information, you can always opt-out at a later date. We provide you with a choice of whether to receive certain emails. We provide you the opportunity to 'opt-out'. If you are a user of the Sites and you no longer wish to receive, email, mail, or telephone calls from us or have your email address, you may opt-out of receiving email.</p>
                                </div>
                            </li>
                            <li className="accordion-item" data-accordion-item>
                                <a href="#" className="accordion-title">5. Non-disclosure</a>
                                <div className="accordion-content" data-tab-content>
                            ...
                            <li className="accordion-item" data-accordion-item>
                                <a href="#" className="accordion-title">6. Winners will be entitled to participate in a lucky draw if they meet the following terms and conditions:</a>
                                <div className="accordion-content" data-tab-content>
                            ...
                            <li className="accordion-item" data-accordion-item>
                                <a href="#" className="accordion-title">7. The rules of Photo Booth lucky draw and how to enter are as follows:</a>
                                <div className="accordion-content" data-tab-content>
                            ...
                            <li className="accordion-item" data-accordion-item>
                                <a href="#" className="accordion-title">8. Other terms & conditions:</a>
                                <div className="accordion-content" data-tab-content>
