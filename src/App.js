                    ...
                    <section className="callout large contest-info">
                        <section className="grid-container">
                            ...
                            <section className="row column text-center small-text-justify">
                                <p>
                                    Every customer of our product got a chance
                                    of winning a free dairy package!
                                </p>
                                <p>
                                    <strong>Yogurt tips:</strong> winners will
                                    be determined by random draw but may have
                                    their entries removed for any reason by the
                                    judges.
                                </p>
                                <p>
                                    Users under the age of 16 are not eligible
                                    for the activity without a guardian's
                                    permission.
                                </p>
                            </section>
                        </section>
