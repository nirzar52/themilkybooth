...
let guardianRequiredError = document.querySelector("#guardianRequiredError");
    ...
    let questionAndAnswers = [
        {question: "111 + 222 + 333", answer: "666"},
        {question: "190 – 87 + 16?", answer: "119"},
        {question: "[-10-3×{4-(-4)}×{3-(5-3)}]", answer: "-34"},
        {question: "57 – 12 = 33 + ?", answer: "12"},
        {question: "200 – (96 ÷ 4)", answer: "176"},
    ];
...
function formChecker(e) {
    ...
    if (errorsDetected > 0) {
        ...
        $("#successReveal-open").trigger('click');
    }
}
// =============================================
// =============================================
