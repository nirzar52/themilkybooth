...
var Foundation = {
   ...
   * @param {String} plugins - optional string of an insectionidual plugin key, attained by calling `$(element).data('pluginName')`, or string of a plugin class i.e. `'dropdown'`
...
var foundation = function(method) {
  ...
  if(type === 'undefined'){//needs to initialize the Foundation object, or an insectionidual plugin.
    Foundation.MediaQuery._init();
    Foundation.reflow(this);
  }else if(type === 'string'){//an insectionidual method to invoke on a plugin or group of plugins
...
OffCanvas.prototype._init = function() {
  ...
  if (this.options.closeOnClick){
    if($('.js-off-canvas-exit').length){
      ...
      var exiter = document.createElement('section');
...
!function($, Foundation){
  ...
  Orbit.defaults = {
    ...
    /**
     * Class applied to insectionidual slides.
     * @option
     * @example 'orbit-slide'
     */
...
!function(Foundation, $) {
  ...
  Reveal.defaults = {
    ...
    btmOffsetPct: 10,
    /**
     * Allows the modal to generate an overlay section, which will cover the view when modal opens.
     * @option
     * @example true
     */
    overlay: true,
  ...
  /**
   * Creates an overlay section to display behind the modal.
   * @private
   */
  Reveal.prototype._makeOverlay = function(id){
    var $overlay = $('<section></section>')
...
!function($, Foundation){
  ...
  Sticky.defaults = {
     ...
     * @option
     * @example '<section data-sticky-container class="small-6 columns"></section>'
     */
    container: '<section data-sticky-container></section>',
    /**
...
!function($, document, Foundation){
  ...
  Tooltip.defaults = {
     ...
     * @option
     * @example '<section class="tooltip"></section>'
     */
    template: '',
    /**
  ...
  Tooltip.prototype._buildTemplate = function(id){
    ...
    var $template =  $('<section></section>').addClass(templateClasses).attr({
      'role': 'tooltip',
      'aria-hidden': true,
...
var endEvent = (function() {
  ...
  var elem = window.document.createElement('section');
